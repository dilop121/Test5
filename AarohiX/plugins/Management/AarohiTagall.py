...
@app.on_message(filters.command(["all", "tagall", "tagmember", "stag", "hftag", "bstag", "eftag", "tag", "etag"], prefixes=["/", "@", "#"]))
async def mentionall(client, message):
    ...
    if message.reply_to_message and message.text:
        ...
        if not msg:
            return await message.reply("/all  𝐓𝐲𝐩𝐞 𝐋𝐢𝐤𝐞 𝐓𝐡𝐢𝐬 / 𝐑𝐞𝐩𝐥𝐲 𝐀𝐧𝐲 𝐌𝐞𝐬𝐬𝐚𝐠𝐞 𝐍𝐞𝐱𝐭 𝐓𝐢𝐦𝐞 ...")
    else:
        return await message.reply("/all  𝐓𝐲𝐩𝐞 𝐋𝐢𝐤𝐞 𝐓𝐡𝐢𝐬 / 𝐑𝐞𝐩𝐥𝐲 𝐀𝐧𝐲 𝐌𝐞𝐬𝐬𝐚𝐠𝐞 𝐍𝐞𝐱𝐭 𝐓𝐢𝐦𝐞 ..")
...
@app.on_message(filters.command(["cancel", "tagcancel"]))
